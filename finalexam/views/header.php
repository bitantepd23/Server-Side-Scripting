...
<title>Computer Science Page</title>
...
<body>
 <div class='row' id='outerbox'>
   <div class='col-xs-12' id='logos'>
	 <div class='col-md-6'> <img src="http://cs.uww.edu/beta/cs/images/uww-logo.jpg" alt='UW-Whitewater'></div>
   ...
   <div class='row'> 
   	<div class='col-xs-12' id='info-box'>
                ...
                <?php if (isset($_SESSION['user'])){
                      echo "<div class='col-xs-4 a-menu'>You are logged in as ".$_SESSION['user']."</div>";
